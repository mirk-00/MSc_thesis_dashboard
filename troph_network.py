    ...
    (function() {
        ...
        dbc.Tab([
            ...
            Dset('''
                ...
                <br> It is important to notice that different types of aggregations can greatly affect the value of MTI.
            '''),
            dcc.Graph(
        ...
        dbc.Tab([
            ...
            Dset('''
                ...
                <br>For this reason much care must be taken when interpreting keystoneness results to aid management decisions.
                <br>In this case for example, according to the
                grade of ecological aggregation, very different conclusion can be drawn. If the model had been built using high-definition data, it could have been inferred
        ...
        dbc.Tab(
            ...
            children=[
                ...
                Dset('Betweenness is a centrality measure of a node in a graph (network). High values for one group indicate that it connects nodes otherwise largely or completely disconnected.'),
                dcc.Graph(
